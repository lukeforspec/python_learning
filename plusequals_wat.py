...
def tuple_what():
    # a_tuple = (1, 2)
    # a_tuple[0] += 1  # obvious error, tuple immutable, its elements are.
    ...
    try:
        pros_and_cons[0] += ["James is cool"]  # maybe? Did error.
    except TypeError:
        print("Error!")
    print(pros_and_cons)  # wat? Element did append

# += did both as it is supposed to work on all elements.
